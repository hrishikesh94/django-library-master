...
from .models import UserProfile, User, Publisher, LendPeriods, Component
...
class BookForm(ModelForm):
    ...
    class Meta:
        model = Component
        fields = ['title', 'catagory' ,'total']
        widgets = {
            'title': forms.widgets.TextInput(attrs={'placeholder': 'Title'}),
            'catagory': forms.widgets.Select(),
            'total': forms.widgets.NumberInput(attrs={'placeholder': 'Quantity'}),
            }
